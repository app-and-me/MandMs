...
VALUES ('1 of 1', '샤이니', '"  . $conn->real_escape_string(file_get_contents("img/1of1.jpg")) . "', 'music/1 of 1.mp3'),
       ...
       ('퀸카', '여자 아이들', '"  . $conn->real_escape_string(file_get_contents("img/퀸카.png")) . "', 'music/퀸카.mp3'),
       ('보트', '죠지', '"  . $conn->real_escape_string(file_get_contents("img/boat.png")) . "', 'music/[Lyrics   가사] 죠지 (George) - 보트 (Boat).mp3'),
       ('out of time', 'the weeknd', '"  . $conn->real_escape_string(file_get_contents("img/out of time.png")) . "', 'music/✨시티팝 찢었다  The Weeknd - Out of Time [가사 해석 lyrics].mp3'),
       ('그라데이션', '십센치', '"  . $conn->real_escape_string(file_get_contents("img/그라데이션.png")) . "', 'music/10CM – Gradation (그라데이션)   Kpop  OST  Lyrics   가사   한글.mp3'),
       ('넥스트레벨', '에스파', '"  . $conn->real_escape_string(file_get_contents("img/넥스트레벨.png")) . "', 'music/넥스트레벨.mp3'),
       ('spicy', '에스파', '"  . $conn->real_escape_string(file_get_contents("img/스파이시.png")) . "', 'music/aespa Spicy Lyrics (에스파 Spicy 가사) (Color Coded Lyrics).mp3'),
       ('에라 모르겠다', '빅뱅', '"  . $conn->real_escape_string(file_get_contents("img/에라모르겠다.png")) . "', 'music/BIGBANG FXXK IT Lyrics (빅뱅 에라 모르겠다 가사) (Color Coded Lyrics).mp3'),
       ('핑크베놈', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/핑크베놈.png")) . "', 'music/BLACKPINK - ‘Pink Venom’ (Official Audio).mp3'),
       ('셧다운', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/셧다운.png")) . "', 'music/BLACKPINK - ‘Shut Down’ M V.mp3'),
       ('뚜두뚜두', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/뚜두뚜두.png")) . "', 'music/BLACKPINK - ‘뚜두뚜두 (DDU-DU DDU-DU)’ M V.mp3'),
       ('붐바야', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/붐바야.png")) . "', 'music/BLACKPINK – BOOMBAYAH (붐바야) (Color Coded Han Rom Eng Lyrics)   by Yankat.mp3'),
       ('kill this love', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/kill this love.png")) . "', 'music/BLACKPINK - Kill This Love (Color Coded Lyrics Eng Rom Han 가사).mp3'),
       ('휘파람', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/휘파람.png")) . "', 'music/BLACKPINK – Whistle (휘파람) (Color Coded Han Rom Eng Lyrics)   by Yankat.mp3'),
       ('럽식걸즈', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/Lovesick Girls.png")) . "', 'music/BLACKPINK Lovesick Girls Lyrics (블랙핑크 Lovesick Girls 가사) [Color Coded Lyrics Han Rom Eng].mp3'),
       ('화이팅 해야지', '부석순', '"  . $conn->real_escape_string(file_get_contents("img/화이팅 해야지.png")) . "', 'music/화이팅해야지.mp3'),
       ('dangerously', '찰리푸스', '"  . $conn->real_escape_string(file_get_contents("img/dangerously.png")) . "', 'music/Charlie Puth - Dangerously [Official Audio].mp3'),
       ('여름여름해', '여자친구', '"  . $conn->real_escape_string(file_get_contents("img/여름여름해.png")) . "', 'music/GFRIEND(여자친구) - Sunny Summer (여름여름해) LYRICS (Color Coded Eng Rom Han 가사).mp3'),
       ('all i wanna do', '박재범', '"  . $conn->real_escape_string(file_get_contents("img/all i wanna do.png")) . "', 'music/Jay Park(박재범) - All I Wanna Do (feat. Hoody & Loco) 가사ㅣLyricㅣsmay.mp3'),
       ('솔로', '제니', '"  . $conn->real_escape_string(file_get_contents("img/SOLO.png")) . "', 'music/솔로.mp3'),
       ('all eyes on me', '지수', '"  . $conn->real_escape_string(file_get_contents("img/all eyes on me.png")) . "', 'music/JISOO All Eyes On Me Lyrics (지수 All Eyes On Me 가사) (Color Coded Lyrics).mp3'),
       ('꽃', '지수', '"  . $conn->real_escape_string(file_get_contents("img/꽃.png")) . "', 'music/JISOO FLOWER Lyrics (지수 꽃 가사) (Color Coded Lyrics).mp3'),
       ('ANTIFRAGLE', '르세라핌', '"  . $conn->real_escape_string(file_get_contents("img/ANTIFRAGLE.png")) . "', 'music/ANTIFRAGLE.mp3'),
       ('이브 프시케 그리고 푸른 수염의 아내', '르세라핌', '"  . $conn->real_escape_string(file_get_contents("img/이브 프시케 그리고 푸른 수염의 아내.png")) . "', 'music/이브 프시케 그리고 푸른 수염의 아내.mp3'),
       ('Fearless', '르세라핌', '"  . $conn->real_escape_string(file_get_contents("img/Fearless.png")) . "', 'music/LE SSERAFIM FEARLESS Lyrics (레세라핌 피어리스 가사) [Color Coded Lyrics Eng Rom Han 가사].mp3'),
       ('unforgiven', '르세라핌', '"  . $conn->real_escape_string(file_get_contents("img/unforgiven.png")) . "', 'music/LE SSERAFIM UNFORGIVEN (feat. Nile Rodgers) Lyrics (Color Coded Lyrics).mp3'),
       ('영웅', '엔씨티 127', '"  . $conn->real_escape_string(file_get_contents("img/영웅.png")) . "', 'music/kick it.mp3'),
       ...
       ('shake it', '씨스타', '"  . $conn->real_escape_string(file_get_contents("img/shake it.png")) . "', 'music/SISTAR (씨스타) - SHAKE IT (Color Coded Han Rom Eng Lyrics)   by YankaT.mp3'),
       ('백도어', '스키즈', '"  . $conn->real_escape_string(file_get_contents("img/백도어.png")) . "', 'music/Stray Kids  Back Door  Lyrics (스트레이 키즈 Back Door 가사) (Color Coded Lyrics).mp3'),
       ('after hours', 'the weeknd', '"  . $conn->real_escape_string(file_get_contents("img/after hours.png")) . "', 'music/The Weeknd (위켄드) - After Hours [가사해석 번역].mp3'),
       ('on your own', 'vacations', '"  . $conn->real_escape_string(file_get_contents("img/on your own.png")) . "', 'music/VACATIONS - On Your Own (Single).mp3'),
       ('Young, Dumb, Stupid', '엔믹스', '"  . $conn->real_escape_string(file_get_contents("img/Young Dumb Stupid.png")) . "', 'music/Young, Dumb, Stupid.mp3'),
       ('die for you', 'the weeknd', '"  . $conn->real_escape_string(file_get_contents("img/die for you.png")) . "', 'music/사랑 때문에 죽을 수 있어 Die for you - The weeknd [가사해석 자막 lyric].mp3'),
       ('다시여기바닷가', '싹쓰리', '"  . $conn->real_escape_string(file_get_contents("img/다시여기바닷가.png")) . "', 'music/싹쓰리 다시 여기 바닷가 가사 (SSAK3 Beach Again Lyrics) [Color Coded Lyrics Han Rom Eng].mp3'),
       ('러빙유', '씨스타', '"  . $conn->real_escape_string(file_get_contents("img/러빙유.png")) . "', 'music/씨스타 - Loving U (러빙유) [가사 Lyrics].mp3'),
