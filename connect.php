...
VALUES ('1 of 1', '샤이니', '"  . $conn->real_escape_string(file_get_contents("img/1of1.jpg")) . "', 'music/1 of 1.mp3'),
       ...
       ('마지막처럼', '블랙핑크', '"  . $conn->real_escape_string(file_get_contents("img/마지막처럼.jpg")) . "', 'music/BLACKPINK - AS IF IT'S YOUR LAST (마지막처럼) [HAN ROM ENG Color Coded Lyrics].mp3')
       ...
       ('englishman in new york', 'sting', '"  . $conn->real_escape_string(file_get_contents("img/englishman in new york.jpg")) . "', 'music/englishman in new york.mp3'),
       ...
       ('love me rigth', '엑소', '"  . $conn->real_escape_string(file_get_contents("img/love mt rigth.jpg")) . "', 'music/love me rigth.mp3'),
       ...
       ('90's love', 'nct u', '"  . $conn->real_escape_string(file_get_contents("img/90's love.jpg")) . "', 'music/NCT U '90's Love' Lyrics (Color Coded Lyrics).mp3'),
       ...
       ('MUST HAVE LOVE', 'SG 워너비 와 브라운 아이드 걸스', '"  . $conn->real_escape_string(file_get_contents("img/SG 워너비 와 브라운 아이드 걸스.jpg")) . "', 'music/MUST HAVE LOVE.mp3'),
